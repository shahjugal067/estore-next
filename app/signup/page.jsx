        ...
        <div className='flex justify-center items-center min-h-screen overflow-hidden bg-blue-200 relative'>
            ...
            className='bg-white p-8 rounded-lg shadow-2xl w-full max-w-md relative z-10'>
                ...
                <div className='text-center mb-8'>
                    ...
                    <h3 className='text-3xl text-gray-900'>Create an Account</h3>
                    <p>Sign up to get started</p>
                </div>
                <form onSubmit={handleSubmit} className='space-y-6'>
                    <div className='relative'>
                    <User className='absolute w-5 h-5 left-3 top-2 text-yellow-400'/>
                        <Input type='text' name='name' id='name' placeholder='Enter name'
                        onChange={handleInputChange} value={user.name} required className='px-10 border-green-400'/>
                    </div>
                    <div className='relative'>
                   ...
                   <Eye 
                    ...
                    {showPassword ? (
                        ...
                        <Input type={showConfirmPassword ? 'text' : 'password'} name='confirmPassword' id='confirmPassword' placeholder='Enter Confirm Password'
                        onChange={handleInputChange} value={user.confirmPassword} required className='px-10 border-green-400'/>
                    </div>
                ...
                <div className='mt-6'>
                        <div className='relative'>
                            ...
                            <div className='relative flex justify-center text-sm'>
                                <span className='px-2 bg-yellow-200'>Or Sign Up with</span>
                            </div>
                        </div>
                        <div  className='mt-6'>
                ...
                <p className='mt-4'>Alredy have an account? <Link href='/login' className='text-blue-500'>Login</Link></p>
